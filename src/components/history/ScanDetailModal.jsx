    ...
    <>
      ...
      <div className="fixed inset-0 z-[9999] overflow-y-auto">
        <div className="min-h-screen flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-5xl overflow-hidden max-h-[95vh] flex flex-col shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] border border-gray-100 animate-scale-in transition-all duration-300">
            {/* Header */}
            ...
            {/* Content - Scrollable */}
            <div className="flex-1 overflow-y-auto p-6 lg:p-8 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
              <div className="grid md:grid-cols-2 gap-8">
                {/* Product Image */}
                <div className="md:col-span-1">
                  <div className="aspect-square rounded-xl overflow-hidden bg-gray-50 shadow-md border border-gray-100 group">
                    <img
                      ...
                      {scan?.kandungan_gizi &&
                        Object.entries(scan.kandungan_gizi).map(
                          ([key, value]) => (
                            <div
                              key={key}
                              className="bg-gray-50 p-5 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-highlight group"
                            >
                              <div className="text-base font-medium text-gray-600 mb-2 group-hover:text-main">
                                {key
                                  .replace(/_/g, " ")
                                  .replace(/\b\w/g, (l) => l.toUpperCase())}
                              </div>
                              <div className="text-2xl font-bold text-main group-hover:text-highlight transition-colors">
            ...
            {/* Footer */}
            <div className="p-6 border-t border-gray-100 bg-gradient-to-r from-gray-50 to-white sticky bottom-0 z-10">
              <button
                onClick={onClose}
                className="w-full px-6 py-3.5 bg-main text-white rounded-xl hover:bg-main/90 transition-all duration-300 font-medium text-lg shadow-sm hover:shadow-md active:scale-[0.98]"
              >
                Tutup
              </button>
            </div>
