    ...
    >
      ...
      <div className="p-4 md:p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div
            className="bg-teal-50 hover:bg-main/5 transition-all duration-300 rounded-xl p-5 hover:shadow-lg animate-fade-in-left h-full"
          ...
          <div
            className="bg-teal-50 hover:bg-main/5 transition-all duration-300 rounded-xl p-5 hover:shadow-lg animate-fade-in-right h-full"
