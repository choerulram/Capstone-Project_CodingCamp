  ...
  useEffect(() => {
    const predictDiseaseRisk = async () => {
      ...
      try {
        ...
        // Mengambil riwayat pemindaian seminggu terakhir
        ...
        const weeklyHistory = allScans.filter((scan) => {
        ...
        if (weeklyHistory.length === 0) {
          throw new Error(
            "Anda belum memiliki riwayat pemindaian minggu ini. Silakan lakukan pemindaian makanan terlebih dahulu."
          );
        }

        // Menghitung total nutrisi mingguan dengan explicit type conversion
        ...
        const daysInWeek = 7;
        const avgNutrisi = {
          Calories: totalNutrisi.Calories / daysInWeek,
          Protein: totalNutrisi.Protein / daysInWeek,
          Fat: totalNutrisi.Fat / daysInWeek,
          Carbohydrates: totalNutrisi.Carbohydrates / daysInWeek,
          Fiber: totalNutrisi.Fiber / daysInWeek,
          Sugar: totalNutrisi.Sugar / daysInWeek,
          Sodium: totalNutrisi.Sodium / daysInWeek,
        };
      ...
      <h2 className="text-base sm:text-lg md:text-xl font-bold text-main mb-4 sm:mb-6 md:mb-8 flex items-center animate-float">
        ...
        <div>
          ...
          <div className="text-xs sm:text-xs md:text-sm text-gray-500 mt-0.5 sm:mt-1">
            Berdasarkan pola makan seminggu terakhir
          </div>
        </div>
      </h2>
...
export default WeeklyDiseasePrediction;
